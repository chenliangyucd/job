  ...
  render () {
    return (
      <div>
        ...
        <List>
          <Item>
            <InputItem onChange={(value)=> {this.changeState('job', value)}}>应聘职位</InputItem>
          </Item>
          <Item>
            <InputItem onChange={(value)=> {this.changeState('company', value)}}>原公司名称</InputItem>
          </Item>
          <Item>
            <InputItem onChange={(value)=> {this.changeState('salary', value)}}>期望薪资</InputItem>
          </Item>
          <Item>
            <InputItem onChange={(value)=> {this.changeState('job_condition', value)}}>应聘要求</InputItem>
          </Item>     
        </List>
